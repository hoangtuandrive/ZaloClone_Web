...
export declare type ChatRoomUser = LazyLoading extends LazyLoadingDisabled
  ? EagerChatRoomUser
  : LazyChatRoomUser;

export declare const ChatRoomUser: (new (
  init: ModelInit<ChatRoomUser, ChatRoomUserMetaData>
) => ChatRoomUser) & {
  copyOf(
    source: ChatRoomUser,
    mutator: (
